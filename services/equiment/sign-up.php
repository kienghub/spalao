...
<body>
                                             ...
                                             <div class="row gutters">
                                                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                       <div class="form-group">
                                                            ...
                                                            <select class="form-control select2" name="e_cate_id"
                                                                 required>
                                                    ...
                                                    ?>
                                                       ...
                                                       <div class="form-group">
                                                            <label for="fullName">ຊື່ອຸປະກອນ(ລາວ)
                                                                 <?php isVal() ?></label>
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control text-right"
                                                                 name="e_Bprice" placeholder="0">
                                                       </div>
                                                       <div class="form-group">
                                                            <label for="fullName">ໝາຍເຫດ</label>
                                                            <textarea name="e_note" id="e_note" cols="30"
    ...
    if (isset($_POST['_handleSubmit'])) {
        ...
        if ($res > 0) {
            ...
            $data = "'$id_number','$_AUTO_ID','$e_cate_id','$e_name_l','$e_name_e','$e_type','$e_size','$e_Bprice','true','$img','$e_note','$_DATE','$_USER_ID'";

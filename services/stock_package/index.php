...
<body ng-app="app" ng-controller="controller" ng-init="_callProduct();_callCategory();cate_id='<?php echo $_GET['id'] ?>';_callMember()">
     <!-- Page wrapper start -->
                                   ...
                                   <div class="row no-gutters">
                                        <div class="col-10">
                                             <div class="labels-container p-3">
                                                  <div id="elem">
                                                       <label onclick="window.location='./'" class="list-menu <?php if (!$_GET['id']) {
                                                                                                                   echo 'active';
                                                                                                              } else {
                                                                                                                   echo '';
                                                                                                              } ?>">
                                                       ...
                                                       foreach ($callPackage as $key) { ?>
                                                            <label class="list-menu <?php if ($_GET['id'] == $key['cate_id']) {
                                                                                          echo 'active';
                                                                                     } else {
                                                                                          echo '';

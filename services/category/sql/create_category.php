...
// INSERT DATA
    if ($btnName == "ບັນທຶກ") {
        ...
        if($_count > 0){
            ...
            $_DATA="'$_AUTO_ID','$cate_title','$cate_note','$_TIMESTAM','$_USER_ID'";
        ...
        $_update =$_SQL($con, "UPDATE spa_category SET 
            cate_title='$cate_title',cate_note='$cate_note',cate_createdAt='$_TIMESTAM',cate_createdBy='$_USER_ID' WHERE cate_id='$id'");
        if ($_update) {
            echo 7070;
        }else {
            echo 4466;

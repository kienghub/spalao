...
// INSERT DATA
    if ($btnName == "ບັນທຶກ") {
        ...
        if($_count > 0){
            ...
            $_DATA="'$_AUTO_ID','$etype_name_l','$etype_name_e','$_TIMESTAMP','$_USER_ID'";
        ...
        $id= $info->etype_id;
        $updateNewData="etype_name_l='$etype_name_l',etype_name_e='$etype_name_e',etype_createdAt='$_TIMESTAMP',etype_createdBy='$_USER_ID'";

...
<body ng-app="app" ng-controller='user'>
     ...
     <div class="page-wrapper pinned">
          ...
          <div class="page-content">
               ...
               <!-- Page header start -->
               <?php 
                $_callUserData=$_SQL($con,"SELECT*FROM spa_users where user_id='2011200803'");
               ...
               <div class="page-header">
                    <ol class="breadcrumb">
                         <li class="breadcrumb-item" onclick="window.location='../settings/'">
                              ຈັດການຂໍ້ມູນ</li>
                         <li class="breadcrumb-item" onclick="window.location='./index.php'">
                                        ...
                                        <div class="card-body">
                                             <div class="account-settings">
                                                            ...
                                                            <div class="image">
                                                                 <div class="dropbox">
                                                                      <input type="file" name="user_img"
                                                                           ...
                                                                           multiple style="display: none!important" />
                                                                      <label for="file-5">
                                                  ...
                                                  <span class="input-group-btn"
                                                       ...
                                                       <button type="button"
                                                            onclick="_onDelete('<?php echo $_GET['id'] ?>')"
                                        ...
                                        <hr>
                                             <div class="row gutters">
                                                  <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                       ...
                                                       <div class="form-group">
                                                            ...
                                                            <div class="m-2">
                                                                 <div
                                                                      ...
                                                                      <input type="radio" id="user_gender"
                                                       ...
                                                       <div class="form-group">
                                                            <label for="fullName">ຊື່ເຂົ້າໃຊ້ລະບົບ
                                                                 <?php isVal()?></label>
    ...
    if(isset($_POST['_handleSubmit'])){
        ...
        $_newData="user_fname='$user_fname',user_lname='$user_lname',user_gender='$user_gender', user_address='$user_address',user_tel='$user_tel',user_name='$user_name', user_role='$user_role',user_img='$img', user_createdAt='$_DATE',user_createdBy='$_USER_NAME'";

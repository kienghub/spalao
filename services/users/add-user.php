                              ...
                              <form action="#" method="post" enctype="multipart/form-data">
                                   <div class="card m-0">
                                        <div class="card-header">
                                             <div class="card-title"><i class="icon-user-plus"></i> ເພີ່ມຂໍ້ມູນຜູ້ໃຊ້
                                             </div>
                                        ...
                                        <div class="card-body">
                                             ...
                                             <div class="form-group">
                                                  ...
                                                  <input type="number" class="form-control" id="user_tel"
                                                       name="user_tel" placeholder="ກະລຸນາປ້ອນເບີໂທ" required>
                                             </div>
                                             <div class="form-group">
                                                  <label for="">ຊື່ເຂົ້າໃຊ້ລະບົບ <?php isVal()?></label>
                                                  <input type="text" id="user_name" class="form-control"
                                                       name="user_name" placeholder="ກະລຸນາປ້ອນຊື່ເຂົ້າໃຊ້ລະບົບ"
                                                       required>
                                             </div>
                                             <div class="form-group">
